...
import { Home, SquareTerminal, PanelBottomOpen, Newspaper, FileUser } from "lucide-react";
import {
  AnimatePresence,
  MotionValue,
  motion,
...
const links = [
    ...
    },
    {
      title: "Projects",
      icon: (
        <SquareTerminal className="h-full w-full text-neutral-500 dark:text-neutral-300" />
      ),
      href: "#",
    },
    {
      ...
      icon: (
        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub</title>
          <path 
            ...
            className="fill-current text-neutral-500 dark:text-neutral-300"
          />
        </svg>
      ),
      href: "#",
  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
       ...
       >
          <PanelBottomOpen
            className={`size-5 text-neutral-500 dark:text-neutral-400 transition-all duration-200 ease-in-out ${
